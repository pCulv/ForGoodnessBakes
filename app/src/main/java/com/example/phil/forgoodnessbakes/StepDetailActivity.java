...
public class StepDetailActivity extends AppCompatActivity implements ExoPlayer.EventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nutella_step_detail);
        ...
        if (Objects.equals(videoUrl, "")) {
            Toast.makeText(this, "No Video For This Step", Toast.LENGTH_LONG).show();
        }
    ...
    private void initializePlayer(Uri mediaUri) {
        if (mExoPlayer == null) {
            ...
            String userAgent = Util.getUserAgent(this, "ForGoodnessBakes");
